/**
 * Rótulo de valor sempre visível para barras horizontais do Recharts
 * (`<BarChart layout="vertical">`). Mesmo comportamento de
 * `renderPercentBarLabel` (@/components/ui/percent-bar-label), só que
 * genérico: recebe um formatador (`formatCurrency`, `formatNumber`, etc.)
 * em vez de fixar o sufixo "%".
 *
 * Em barras longas o texto fica dentro da barra, alinhado à direita, em
 * branco. Em barras curtas (onde o texto não caberia dentro da área
 * colorida) o rótulo "vaza" para fora, logo à direita da barra.
 */
