    ...
    <div className="space-y-6">
      ...
      {!canCreate && (
        <p className="text-xs text-nord-warning bg-nord-warning/10 border border-nord-warning/30 rounded-lg px-3 py-2">
          {isGrupoNordMode
            ? "Você está no modo Grupo Nord (consolidado). Selecione uma loja específica no menu lateral para registrar ou importar o ponto."
            : "Seu perfil de permissão não permite registrar ou importar o ponto neste módulo."}
        </p>
      )}
