...
// usuário logado digitando a URL direto recebia o HTML já renderizado com as cartilhas. Cargo
// (mesma checagem das rotas irmãs `/api/admin/files/**`) + hasModulePermission no módulo
// "administrativo" (perfil só restringe além do cargo, nunca libera além dele).
