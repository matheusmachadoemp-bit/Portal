  ...
  return (
    <div className="space-y-6">
      ...
      {/* Sem loja específica selecionada (visão consolidada "Grupo Nord"), a reunião não
          ...
          (reaproveitado aqui em vez de inventar um texto novo). `!canCreate` aqui tem 2
          motivos possíveis: visão consolidada "Grupo Nord" (sem loja específica selecionada)
          ou falta de permissão real (canEdit) numa loja única — ver comentário de `canCreate`
          em page.tsx. isGrupoNordMode escolhe a mensagem certa, mesmo padrão do item #255
          (ex.: movimentacoes-client.tsx, insumos-client.tsx). */}
      {!canCreate && (
